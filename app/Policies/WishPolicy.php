...
class WishPolicy
{
    ...
    {
        return $user->can('delete_any_wish');
    }
     ...
     */
    public function replicate(User $user, Wish $wish): bool
    {
