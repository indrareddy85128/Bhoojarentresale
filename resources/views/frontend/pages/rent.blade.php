                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <label class="radio-button-container">Owner
                                                <input type="radio" id="role-1" value="owner" name="rent_options"
                                                    onclick="toggleInputs()">
                                                <span class="checkradio"></span>
                                            </label>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <label class="radio-button-container">Tenant
                                                <input type="radio" id="role-1" value="tenant" name="rent_options"
                                                    onclick="toggleInputs()">
                                                <span class="checkradio"></span>
                                            </label>
                                        </div>
